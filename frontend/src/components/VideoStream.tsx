...
// ─── CONFIG ──────────────────────────────────────────────────────────────────
// const DEFAULT_API = "http://20.109.26.150:8000";
// const NGINX_API = "http://20.109.26.150:8080";
const DEFAULT_API = import.meta.env.VITE_DEFAULT_API;
const NGINX_API = import.meta.env.VITE_NGINX_API;


// ─── TYPES ──────────────────────────────────────────────────────────────────
type TabId = "upload" | "stream" | "status";
...
// Interface for component props (if any child components need them)
...
const VideoStream: React.FC = () => {
  ...
  const [liveBase, setLiveBase] = useState<string>(NGINX_API);

  const handleApiBaseChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
    setApiBase(e.target.value.replace(/\/+$/, ""));
  };
